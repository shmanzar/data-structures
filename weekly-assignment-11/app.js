...
app.get('/aa', function(req, res) {
    ...
    // SQL query 
    var thisQuery = `SELECT GeoCoord.latlong, json_agg(json_build_object('loc', Building_name, 'address', Address, 'time', EndTime, 'name', Meeting_name, 'day', WeekDay, 'types', Meeting_typeName, 'shour', StartTime)) as meetings
                 FROM aalocations 
